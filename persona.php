...
public static function LeerPersonas($codigo, $anio)
{
	...
	if ($codigo!=0)
	{
		...
		$tabla= "<table id='example' class='table table-striped table-bordered dataTable' cellspacing='0' width='100%' role='grid' aria-describedby='example_info' style='width: 100%;'>
				<thead>
					<tr>
						<th>  Numero   </th>
						<th>  Empresa   </th>
...
if ($grupo=="todos")
{
		...
		$tabla= "<table table id='example' class='table table-striped table-bordered dataTable' cellspacing='0' width='100%' role='grid' aria-describedby='example_info' style='width: 100%;'>
				<thead>
					<tr>
						<th>  Numero   </th>
						<th>  Empresa   </th>
